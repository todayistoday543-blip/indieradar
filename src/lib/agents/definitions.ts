...
export const AGENTS: Record<string, AgentDefinition> = {
  ceo: {
    ...
    system_prompt: `あなたはNicheHuntのCEOエージェントです。
...
常にユーザー価値とビジネス成長のバランスを取ってください。`,
  ...
  content: {
    ...
    system_prompt: `あなたはNicheHuntのコンテンツ部門エージェントです。
...
品質の高い翻訳と実用的なインサイトの生成に集中してください。`,
  ...
  moderation: {
    ...
    system_prompt: `あなたはNicheHuntのモデレーション部門エージェントです。
...
公正かつ迅速な判断を心がけてください。`,
  ...
  analytics: {
    ...
    system_prompt: `あなたはNicheHuntのアナリティクス部門エージェントです。
...
データに基づく意思決定を支援してください。`,
  ...
  engineering: {
    ...
    system_prompt: `あなたはNicheHuntのエンジニアリング部門エージェントです。
...
コードの品質とパフォーマンスを重視してください。`,
  ...
  growth: {
    ...
    system_prompt: `あなたはNicheHuntのグロース部門エージェントです。
...
データドリブンなグロース戦略を立案してください。`,
  ...
  i18n: {
    ...
    system_prompt: `あなたはNicheHuntの国際化部門エージェントです。
...
文化的なニュアンスを理解した自然な翻訳を心がけてください。`,
  ...
  finance: {
    ...
    system_prompt: `あなたはNicheHuntの財務部門エージェントです。
